...
The Dockerfile used to create this image is available at the root of the file system and on [GitHub](https://github.com/sjiveson/nfs-server-alpine). Here it is anyway:
